...
public class OfficeEscapeView extends JFrame implements PropertyChangeListener {
    ...
    /** The panel that shows text output from the NPCs. */
    InfoConsolePanel myInfoConsolePanel;
    ...
    public OfficeEscapeView(List<Room> theRoomsList,
        ...
        myInfoConsolePanel = new InfoConsolePanel();
        setupUI();
        setupFrame();
        addToolbarPanel();
    ...
    private void addConsolePanel() {
        ...
        myConsolePanel.setBounds(768, 0, 480, 384);
        myConsolePanel.setVisible(true);
    }

    /** Adds a console panel to the frame. */
    private void addInfoConsolePanel() {
        this.add(myInfoConsolePanel);
        myInfoConsolePanel.setBackground(Color.BLACK);
        myInfoConsolePanel.setBounds(768, 384, 480, 288);
        myInfoConsolePanel.setVisible(true);
    }
